...
describe('#303A reminders foundation', () => {
  ...
  it('UI surfaces + in-app delivery without push/cron/openai', () => {
    ...
    assert.match(dueHost, /listDueReminders/)
    assert.match(dueHost, /markReminderDelivered/)
    assert.doesNotMatch(dueHost, /Notification|serviceWorker|web-push|getUserMedia/)
  ...
  it('privacy + feature flags documented', () => {
    ...
    assert.match(privacyCopy, /non vengono ancora inviate notifiche push/)
