 ...
 *
 * #388B.1: Production path uses Web Standard `export default { fetch }`
 * + rawBodyFromWebRequest (request.text()). Node helper exports auto-parse
 * application/json and discard original bytes; Next.js bodyParser:false is
 * ignored on Vite. Do NOT re-stringify parsed JSON for signatures.
 *
