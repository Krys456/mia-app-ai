 ...
 * Requires Vercel/Node bodyParser disabled on the handler.
 *
...
export async function readRawBody(req) {
  ...
  // Last resort: re-serialize parsed JSON (signature will fail if Stripe
  // signed a different byte sequence — prefer failing closed).
