...
function buildAddBrief(insight) {
  ...
  return [
    ...
    `Seed: ${insight.seed}`,
    'Tono: aside naturale intrecciato o in coda — entra nel contenuto; mai “Ecco una cosa interessante…” o etichette di genere.',
    'Lunghezza: 1–3 frasi max; non allungare il resto della risposta.',
    'Vietato: liste di extras, etichette emoji di sezione, ripetere il corpo, domande generiche di chiusura.',
  ].join(' ')
}
