...
// --- Natural Topic Transition (bridge when changing subject · no abrupt jumps) ---
  ...
  if (conversationIntent?.plan?.active && conversationIntent.plan.writerBrief) {
    ...
    if (ci.structureLine && !conversationConstitution?.plan?.structureLine && !conversationLeadership?.plan?.structureLine && !thoughtfulness?.plan?.structureLine && !deepThinking?.plan?.structureLine && !deepThinkingWriter?.plan?.structureLine && !reasoningExpansion?.plan?.structureLine && !presence?.plan?.structureLine && !responseMode?.plan?.structureLine && !wisdom?.plan?.structureLine && !conversationTaste?.plan?.structureLine && !conversationMemoryFlow?.plan?.structureLine && !selfReflection?.plan?.structureLine && !socialConversation?.plan?.structureLine) {
      out.push(
        makeSuggestion({
          advisor: 'conversation_intent',
          slot: 'structure',
  ...
  // --- Wisdom Engine (after Response Mode: useful / appropriate / meaningful) ---
...
export function runCognitiveCoordinator(input) {
  ...
  // --- Wisdom Engine (last-mile after Response Mode, before Writer) ---
  ...
  // Wisdom last-mile — after Response Mode
  if (wisdomPlan?.active && wisdomPlan.writerBrief) {
