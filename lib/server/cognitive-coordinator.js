      ...
      out.push(
        makeSuggestion({
          ...
          structure: [
            ...
            'Vietato di default: “How can I help?”, “Tell me.”, “Dimmi pure.”, “Priorità di oggi?”, “Di cosa vuoi parlare?”',
            'Prendi responsabilità; porta UNA direzione interessante',
            `Obiettivo reale da servire: ${plan.realGoal}`,
          ],
          text: wc.writerBrief,
          confidence: wc.confidence === 'high' ? 0.88 : 0.75,
  ...
  if (
    ...
    if (welcome.plan.mode === 'warm_handoff' || strategy === 'warm_handoff') {
      ...
      structure = [
        ...
        'Partner di conversazione: se il filo è vuoto, porta UNA idea leggera — non un’intervista',
        'Vietato: “How can I help?”, “Tell me.”, “Dimmi pure.”, “Priorità di oggi?”, “Di cosa vuoi parlare?”',
        `Obiettivo reale da servire: ${plan.realGoal}`,
      ]
    } else {
      structure = [
