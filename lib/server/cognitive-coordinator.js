  ...
  if (feedbackInterpretation?.plan?.active && feedbackInterpretation.plan.writerBrief) {
    ...
    out.push(
      makeSuggestion({
        advisor: 'feedback_interpretation',
        slot: 'style',
        text: `Feedback Interpretation: adatta subito (${fb.kind}). Non trattare come domanda fattuale; niente lezioni ovvie; niente “Vuoi che…?”.`,
      ...
      out.push(
        makeSuggestion({
          ...
          structure: [
            ...
            'Vietato: spiegare concetti ovvi; chiedere conferma del feedback',
            `Obiettivo reale da servire: ${plan.realGoal}`,
          ],
          text: fb.writerBrief,
          confidence: fb.confidence || 0.8,
