    ...
    if (wc.ownsOpening && !wc.softStyleOnly && !welcomeOwns && !continuationOwnsOpening) {
      out.push(
        makeSuggestion({
          ...
          slot: 'opening',
          structure: [
            wc.structureLine || 'Warm Conversation: presenza calda, non helpdesk',
            'Niente “How can I help?” / “Come posso aiutarti?”',
            'Conversazione come valore; benvenuto prima dei problemi',
            `Obiettivo reale da servire: ${plan.realGoal}`,
          ],
          text: wc.writerBrief,
          confidence: wc.confidence === 'high' ? 0.88 : 0.75,
