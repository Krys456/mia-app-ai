...
export function resolveConflicts(deduped, state = {}) {
  ...
  for (const s of deduped) {
    ...
    // Coda: exclusive — curiosity / momentum / next_ask bridge — only ONE
    if (s.slot === 'coda') {
