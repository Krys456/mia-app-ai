...
// --- assistant cannot spoof arbitrary images (must be generated|edited) ---
{
  const r = sanitizeMultimodalMessages([
...
// --- assistant generated image allowed for session replay ---
{
  const r = sanitizeMultimodalMessages([
    {
      role: 'assistant',
      content: 'Ecco',
      attachments: [imgAtt({ source: 'generated' })],
    },
  ])
  assert.equal(r.ok, true)
