...
import { decideRouteEntitlement } from './entitlement-gates.js'
 ...
 *   decideRouteEntitlement?: typeof decideRouteEntitlement
...
export async function requirePaidApiAccess(req, res, options) {
  ...
  const decideEntitlement = options.decideRouteEntitlement ?? decideRouteEntitlement
  ...
  // #332C — auth → entitlement (optional) → rate-limit → provider.
