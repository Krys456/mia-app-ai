 ...
 *
 * Key: CALENDAR_TOKEN_ENCRYPTION_KEY — 32 raw bytes as base64 or 64-char hex.
...
/**
 * Parse CALENDAR_TOKEN_ENCRYPTION_KEY into 32 raw bytes.
...
export async function encryptToken(plaintext, keyEnv = undefined) {
  ...
  const parsed = parseEncryptionKey(
    keyEnv !== undefined ? keyEnv : typeof process !== 'undefined' ? process.env.CALENDAR_TOKEN_ENCRYPTION_KEY : '',
  )
