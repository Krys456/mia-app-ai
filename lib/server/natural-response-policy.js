...
export const NATURAL_RESPONSE_POLICY_MAX_CHARS = 4000
...
P0 STOP/COMPLETION: if stop_signal, completion_signal, or initiative=low after a decline/completion cue → ≤1 brief ack then hard stop. Output may be only a short close. FORBIDDEN in that reply: any question; Fammi sapere…; Se hai bisogno…; Se cambi idea…; Sono qui…; Quando vuoi…; Vuoi parlare di altro?; Let me know…; I'm here if…; Se vuoi…; alternatives; new agenda.
