...
export const NATURAL_RESPONSE_POLICY_BUILD = '325-1'
export const NATURAL_RESPONSE_POLICY_MAX_CHARS = 1850
...
Priority: safety/factual/capability → explicit user instruction → task correctness/epistemic honesty → Conversation State → this policy → settings → defaults.
