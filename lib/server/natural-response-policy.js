...
export const NATURAL_RESPONSE_POLICY_BUILD = '367b-1'
export const NATURAL_RESPONSE_POLICY_MAX_CHARS = 6700
...
SHAPE: one-line reaction, short prose, several paragraphs, bullets, steps, comparison, examples, or a table only if helpful. No Markdown mini-articles for casual chat. Casual → prefer prose. COMPRESSION: do not restate/paraphrase the user's message before answering unless it resolves ambiguity or confirms a material constraint; micro conversational beats may remain a few words.
