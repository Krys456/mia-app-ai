...
function generateSurprises(args) {
  ...
  raw.push({
    id: 'twist',
    kind: 'elegant_twist',
    seed: `Un twist semplice su ${label}: la stessa idea vista da un angolo inaspettato ma ancora familiare (1–2 frasi chiare).`,
    curiosityLift: 4.4,
  ...
  raw.push({
    id: 'link',
    kind: 'hidden_link',
    seed: `Un collegamento nascosto ma naturale: ${label} ↔ un concetto vicino che l’utente già conosce — rende più chiaro il “perché”.`,
    curiosityLift: 4.2,
  ...
  raw.push({
    ...
    seed: `Un fatto controintuitivo ma vero su ${label}, detto con calma (niente hype) — e perché ha senso.`,
    curiosityLift: 4.7,
