...
function buildBrief(idea) {
  return [
    ...
    `Porta questo contenuto (senza etichettarlo come “sorpresa”): ${idea.seed}`,
    'Deve: alzare curiosità, migliorare comprensione, restare facile da seguire.',
    'Vietato: sensazionalismo, trivia scollegata, twist confusi, “shocking facts”, annunci di genere.',
