...
function buildCandidates(args) {
  ...
  out.push({
    ...
    probability:
      0.44 +
      (technicalLevel === 'expert' || technicalLevel === 'advanced' ? 0.14 : 0) +
  ...
  if (technicalLevel === 'expert' || technicalLevel === 'advanced' || complexity === 'high') {
    out.push({
      id: 'tradeoff',
      kind: 'tradeoff',
      ...
      probability:
        0.5 +
        (technicalLevel === 'expert' ? 0.12 : technicalLevel === 'advanced' ? 0.08 : 0.05),
