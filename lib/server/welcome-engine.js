...
const GREETING_BANK = [
  ...
  },
  {
    ...
    strategies: ['warm_only'],
    line: ({ name }) =>
      `Eccoti${name ? `, ${name}` : ''}. C’è un filo che mi incuriosisce — ci entro con un’osservazione breve.`,
  },
  {
    id: 'wo-eve-1',
    styles: ['warm', 'calm'],
    ...
    strategies: ['warm_only'],
    line: ({ name }) =>
      `Buonasera${name ? ` ${name}` : ''}. Ritmo calmo — porto un pensiero leggero e concreto.`,
  },
  {
    id: 'wo-night-1',
    ...
    strategies: ['warm_only'],
    line: ({ name }) =>
      `Hey${name ? ` ${name}` : ''}. Ancora sveglio — restiamo su qualcosa di leggero e utile.`,
  },
  {
    id: 'wo-pause-1',
    ...
    strategies: ['warm_only'],
    line: ({ name }) =>
      `Di nuovo qui${name ? `, ${name}` : ''}. Riprendiamo dove ci eravamo lasciati, senza fretta.`,
  },
  {
    id: 'wo-first-1',
    styles: ['warm', 'bright'],
    ...
    strategies: ['warm_only'],
    line: ({ name }) =>
      `Ciao${name ? ` ${name}` : ''}. Sono LAIfe — parto da un’osservazione concreta, non da un menu.`,
  },
  {
    id: 'wo-first-2',
    styles: ['calm', 'terse'],
    ...
    encounters: ['first'],
    strategies: ['warm_only'],
    line: () => `Ciao. Sono LAIfe — un’idea chiara per iniziare, senza fretta.`,
  },
  {
    id: 'wo-stressed-1',
    ...
    encounters: ['any'],
    strategies: ['warm_only'],
    line: ({ name }) => `Hey${name ? ` ${name}` : ''}. Andiamo piano — un pezzo alla volta.`,
  },
  {
    id: 'wo-formal-1',
    styles: ['formal'],
    ...
    strategies: ['warm_only'],
    line: ({ name }) =>
      `Buongiorno${name ? ` ${name}` : ''}. Porto un punto di partenza sobrio e concreto.`,
  },
  ...
  },
  {
    ...
    encounters: ['any'],
    strategies: ['warm_handoff'],
    line: () => `D’accordo — entriamo nel merito.`,
  },
  {
    id: 'wh-5',
    styles: ['calm', 'warm'],
...
export async function buildWelcomePlan(input) {
  ...
  const writerBrief = [
    ...
    `Apertura unica ad alto valore (osservazione / idea / curiosità / storia / insight / fatto sorprendente / collegamento — mai “Dimmi pure.”, “Come posso aiutarti?”, “Qual è la tua priorità?”, “Cosa vuoi sapere?”, “Hai domande?”, “Fammi sapere.”, “Sono qui se ti serve.”): «${greeting.line}»`,
    ...
    nextStep
      ...
      : 'Nessun next step forzato — ma non restare passivo: calore + eventuale idea leggera.',
