...
const GREETING_BANK = [
  ...
  },
  {
    ...
    strategies: ['warm_only'],
    line: ({ name }) =>
      `Hey${name ? ` ${name}` : ''}. Ancora in piedi — ho un pensiero breve da condividere.`,
  },
  {
    id: 'wo-pause-1',
    ...
    strategies: ['warm_only'],
    line: ({ name }) =>
      `Di nuovo qui${name ? `, ${name}` : ''}. Riprendiamo il filo — ho qualcosa di buono in mente.`,
  },
  {
    id: 'wo-first-1',
    styles: ['warm', 'bright'],
  ...
  },
  {
    ...
    encounters: ['first'],
    strategies: ['warm_only'],
    line: () => `Ciao. Sono LAIfe — ho già un’idea da cui partire, senza fretta.`,
  },
  {
    id: 'wo-stressed-1',
  ...
  // —— suggest_next ——
  {
    ...
    line: ({ name, memory }) =>
      memory
        ...
        : `Ciao${name ? ` ${name}` : ''}. Propongo di partire da un’idea concreta — non da un’intervista.`,
  },
  {
    id: 'sn-2',
    styles: ['terse', 'calm'],
    ...
    line: ({ memory }) =>
      memory
        ...
        : `Ciao. Parto io con un filo interessante — poi pieghiamo dove serve.`,
  },
  {
    id: 'sn-3',
    styles: ['formal'],
    ...
    line: ({ name, memory }) =>
      memory
        ...
        : `Buongiorno${name ? ` ${name}` : ''}. Propongo un punto di partenza concreto — non un menu di priorità.`,
  },
  {
    id: 'sn-first-1',
    styles: ['warm', 'bright'],
