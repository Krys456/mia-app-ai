...
export function suggestNextStep(opts) {
  ...
  if (strategy === 'suggest_next') {
    ...
    if (encounterKind === 'first') {
      return 'Apri con UNA idea interessante (non “priorità di oggi?” / non “dimmi pure”)'
    }
    return 'Proponi UNA direzione concreta e sviluppala — non chiedere la priorità'
  }
  return null
}
...
export async function buildWelcomePlan(input) {
  ...
  const strategyGuide = {
    warm_only:
      'Calore umano + presenza da partner: se il filo è vuoto, porta UNA idea leggera — niente “how can I help”, “dimmi pure”, “priorità di oggi”.',
  ...
  const writerBrief = [
    ...
    `Apertura unica (mai “How can I help?”, “Tell me.”, “What would you like to discuss?”, “What is your priority today?”, “Dimmi pure.”, “Di cosa vuoi parlare?”): «${greeting.line}»`,
...
- Mai aperture generiche o da interview (“How can I help?”, “Dimmi pure.”, “Priorità di oggi?”)
