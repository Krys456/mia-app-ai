...
describe('#287 LANGUAGE hardening', () => {
  ...
  it('O/P/Q/R — one responses.create, reasoning.none, stream:false, maxDuration 120', () => {
    ...
    const awaitCreates = [...chat.matchAll(/await\s+client\.responses\.create/g)]
  ...
  it('S — #284/#285/#286 modules still present; NRP replaces Expression/Proactive injection', () => {
    ...
    assert.doesNotMatch(chat, /buildCoreProactiveIntelligenceAppendix/)
    assert.doesNotMatch(chat, /buildCoreExpressionAppendix/)
