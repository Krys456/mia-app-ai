...
// —— No billing / schema ——
{
  ...
  assert.equal(
    migrations.filter((n) => /subscription|billing|entitlement_enforcement/i.test(n)).length,
    0,
  )
  assert.doesNotMatch(read('lib/server/entitlements.js'), /stripe|RevenueCat|StoreKit/i)
