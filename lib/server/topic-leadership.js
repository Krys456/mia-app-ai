...
2. Entra subito nel merito (niente menù, niente “preferisci…?”)
...
function buildWriterBrief(plan) {
  ...
  const t = plan.chosen
  return [
    'TOPIC LEADERSHIP: l’utente ha ceduto la scelta — portala tu, con tono da partner (non da menu).',
    `Una sola direzione: «${t.title}». Entra nel merito. Non ridare il controllo.`,
