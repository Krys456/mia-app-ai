...
function buildBrief(intent) {
  const lines = [
    ...
    'Craft: una mossa chiara con contenuto — non cleverness vuota, non meta-commenti sul “essere presenti”.',
  ]
  ...
  if (intent.optimizeEnjoyment) {
    lines.push(
      'Chiacchiera: ottimizza per conversazione piacevole — osservazione, leggero wit, o un filo curioso; non task completion.',
    )
  }
