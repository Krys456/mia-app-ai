...
export function mergePreSendRefineBudget(opts) {
  ...
  const instructions = [
    'Sei il Writer di LAIfe. Esegui UNA sola rifinitura pre-invio (budget unico: Self-Critique + Satisfaction + companion guards).',
    'Mai un secondo loop. Non inventare. Non allungare a vuoto. Non citare motori/gate.',
    'Priorità: togli generico/ripetizioni/filler/helpdesk; alza chiarezza; un dettaglio vivo se manca; mantieni le idee forti; suona come un interlocutore premium, non un chatbot.',
    ...briefs,
    'Restituisci solo il testo finale migliorato.',
    'Bozza:',
    '---',
