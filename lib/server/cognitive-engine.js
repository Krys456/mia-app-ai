...
export function buildCognitivePlan(
  ...
  // Conversation Intent → Leadership → Deep Thinking guide structure before other advisors reshape it.
  ...
  // Keep Intent + Leadership + Deep Thinking (up to 6 pre-plan lines).
  ...
  // Guarantee Deep Thinking craft lines survive structure rewrites.
  if (deepThinkingStructure.length) {
    const missing = deepThinkingStructure.filter(
