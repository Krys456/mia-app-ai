...
export function buildCognitivePlan(
  ...
  // Social → Intent → Leadership → Thoughtfulness → Deep Thinking → Deep Thinking Writer → Presence → Wisdom → Taste.
...
export async function runCognitiveEngine(input) {
  try {
    ...
    // Conversation Opportunity Engine (AFTER Intent + Emotional State, BEFORE Writer):
    ...
    // Conversation Opening Engine (AFTER Intent + Language + Opportunity, BEFORE Writer): useful first opens.
    ...
    // Presence Engine (after Deep Thinking Writer, before Writer): organic aliveness / style / ending.
