...
export function buildCognitivePlan(
  ...
  // Intent → Leadership → Thoughtfulness → Deep Thinking → Presence → Wisdom → Taste guide structure.
...
export async function runCognitiveEngine(input) {
  try {
    ...
    // Worth Reading Protocol (LAST craft before Writer — after Constitution / before Coordinator+HCS).
