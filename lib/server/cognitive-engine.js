...
export function buildCognitivePlan(
  ...
  // Intent → Leadership → Deep Thinking → Presence → Wisdom guide structure.
  ...
  const craftStructure = [...deepThinkingStructure, ...presenceStructure, ...wisdomStructure]
