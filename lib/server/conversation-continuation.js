...
/**
 * @typedef {'continue_learning'|'acknowledge'|'want_advice'|'finish'|'want_example'|'want_depth'|'engaged_quiet'|'unknown'} ContinuationIntent
 */
...
export function analyzeContinuation(input) {
  ...
  reasons.push('Messaggio molto breve rilevato.')

  // 1) Explicit stop / thanks-as-closure
...
- Mai ignorare stop / grazie di chiusura
