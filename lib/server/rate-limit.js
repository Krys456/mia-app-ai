 ...
 * - translation: 30 / 1 min  (#322 — dedicated OpenAI translation)
 */

import { Ratelimit } from '@upstash/ratelimit'
import { Redis } from '@upstash/redis'

/** @typedef {'chat' | 'selection' | 'tts' | 'files' | 'memories' | 'reminders' | 'push_subscriptions' | 'weather' | 'translation'} RateLimitBucket */
...
export const RATE_LIMIT_POLICY = {
  ...
  translation: { requests: 30, window: '1 m' },
}
