...
export function isPreferencePolarityQuestion(message) {
  ...
  const hasPolarityCue =
    /\b(?:piace|piacciono|like|likes|dislike|dislikes|hate|hates|preferisco|prefer)\b/i.test(
      text,
    )
...
/**
 * Skip like/dislike extraction for third-party, meta-negation, or hypotheticals.
