...
function generateCandidates(args) {
  ...
  raw.push({
    ...
    idea: `Una conseguenza poco attesa di ${label} — detta come fatto, senza annunciare “angolo controintuitivo”`,
    usefulness: 3.2,
    surprise: 4.7,
  ...
  raw.push({
    ...
    idea: `L’errore pratico più comune quando si applica ${label}, e la mossa che lo evita`,
    usefulness: 4.6,
    surprise: 3.4,
    educationalValue: 4.0,
    continuity: 3.8,
  ...
  raw.push({
    id: 'deeper',
    kind: 'deeper_why',
    idea: `Il meccanismo un livello più sotto su ${label} — perché funziona così`,
    usefulness: 3.8,
    surprise: 3.5,
  ...
  raw.push({
    id: 'compare',
    kind: 'comparison',
    idea: `${label} vs l’alternativa più vicina: quando scegliere cosa (una sola differenza)`,
    usefulness: 4.0,
    surprise: 3.2,
  ...
  raw.push({
    id: 'next_skill',
    kind: 'next_skill',
    idea: `Cosa costruire subito dopo aver capito ${label} — un pezzo concreto, non una domanda`,
    usefulness: 4.3,
    surprise: 2.8,
  ...
  raw.push({
    id: 'adjacent',
    kind: 'adjacent_topic',
    idea: `Un tema vicino che rende ${label} più chiaro — collegato, non un reset`,
    usefulness: 3.5,
    surprise: 3.8,
