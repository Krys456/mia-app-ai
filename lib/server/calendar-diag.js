...
export const CALENDAR_DIAG_BUILD = '310C3-1'
...
export function buildChatCalendarDiagPayload(input) {
  ...
  const trace = buildCalendarTraceFromEnrichment(input.enrichment || {})
  ...
  return {
    ...
    ...trace,
    durationMs:
      typeof input.enrichment?.durationMs === 'number' ? input.enrichment.durationMs : null,
  }
}
