...
function buildStyleBrief(behavior, ctx) {
  ...
  const modeLine = {
    conversation:
      'Comportamento: conversazione — partner, non macchina Q&A; guida con leggerezza, porta idee, niente “How can I help?” / “Dimmi pure.” / interview defaults.',
...
function buildResponseHints(behavior, ctx) {
  ...
  switch (behavior) {
    ...
    case 'conversation':
      ...
      hints.push('Vietato di default: “How can I help?”, “Tell me.”, “What would you like to discuss?”, “What is your priority today?”')
      hints.push('Su saluto/incertezza: prendi responsabilità e parti con un filo interessante — non un’intervista')
      break
    default:
