...
function buildStyleBrief(behavior, ctx) {
  ...
  const modeLine = {
    conversation:
      'Comportamento: conversazione — fluido, umano, ascolto attivo; calore genuino, non tono da sportello; niente “How can I help?”.',
...
function buildResponseHints(behavior, ctx) {
  ...
  switch (behavior) {
    ...
    case 'collaboration':
      ...
      break
    case 'conversation':
      hints.push('Calore genuino; conversazione come valore, non rumore prima del task')
      hints.push('Niente “How can I help?” — benvenuto prima dei problemi')
      hints.push('Tono di chi pensa volentieri insieme')
      break
    default:
