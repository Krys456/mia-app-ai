...
function buildStyleBrief(behavior, ctx) {
  ...
  const modeLine = {
    conversation:
      'Comportamento: conversazione — partner non Q&A; aperture ad alto valore (osservazioni, idee, curiosità, storie, insight, fatti sorprendenti, collegamenti); evita “Dimmi pure.” / “Come posso aiutarti?” / “Hai domande?” / “Fammi sapere.” / “Sono qui se ti serve.”.',
...
function buildResponseHints(behavior, ctx) {
  ...
  switch (behavior) {
    case 'explanation':
      ...
      break
    case 'brainstorming':
      hints.push('2–4 direzioni vive come affermazioni — commit su UNA e sviluppala (Question Economy: non chiedere quale esplorare)')
      break
    case 'planning':
    ...
    case 'collaboration':
      ...
      break
    case 'conversation':
      hints.push('Partner di conversazione: guida naturalmente, goditi le idee, costruisci sul contesto')
      hints.push('Evita aperture a basso valore: “Dimmi pure.”, “Come posso aiutarti?”, “Qual è la tua priorità?”, “Cosa vuoi sapere?”, “Hai domande?”, “Fammi sapere.”, “Sono qui se ti serve.”')
      hints.push('Preferisci: osservazioni, idee, curiosità, storie, esperimenti mentali, insight, fatti sorprendenti, collegamenti')
      break
    default:
