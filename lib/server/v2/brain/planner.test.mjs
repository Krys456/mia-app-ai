...
test('78a. encouragement "ok" keeps previous scientific topic', () => {
  ...
  assert(
    /Deepen the previous explanation|Connect to the previous assistant/i.test(p.objective),
...
test('79f. plan emits conversationState and blocks disconnected continuations', () => {
  ...
  assert(
    /Deepen the previous explanation|Open with an unexpected|Create curiosity|Connect to the previous/i.test(
      p.objective,
    ),
