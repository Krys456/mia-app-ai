/**
 * LAIfe V2 — Pipeline (first working slice)
 *
 * Orchestrates: Perception → Mind → Planner → Writer
...
export const PIPELINE_VERSION = '2.0.0-pipeline'
...
/**
 * Create an independent V2 conversation pipeline.
...
export function createPipeline(config = {}) {
  ...
  /**
   * Run one conversation turn through Perception → Mind → Planner → Writer.
