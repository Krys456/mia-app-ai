...
export const MIND_VERSION = '2.0.0-mind'
...
function normalize(input) {
  ...
  return {
    ...
    memory: {
      ...
      currentTopic: asString(m.currentTopic) || null,
    ...
    session: {
      ...
      closingSignal: asBool(s.closingSignal, false),
      preferenceBias:
...
function decideContinueTopic(ctx, strategy, need) {
  const { memory, perception: p, session } = ctx
