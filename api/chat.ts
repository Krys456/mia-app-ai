...
Prima di rispondere: inferisci l’obiettivo sottostante (non solo la domanda letterale). Se la confidenza è bassa, dichiara le assunzioni in una frase; non fingere certezza sui criteri.
