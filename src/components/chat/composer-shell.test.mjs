...
assert.match(shell, /Messaggio per ShinkAIdo|Messaggio per LAIfe/)
...
assert.match(attachMenu, /File \/ Documento/)
...
assert.doesNotMatch(attachMenu, /Coming soon|DOCX|getUserMedia|SpeechRecognition|MediaRecorder|\bInstant\b/)
