...
assert.match(hero, /HomeExperience/)
assert.match(homeExp, /accessibleProductName|BRAND/)
...
assert.match(homeExp, /SumiHero|shinkaido-enso-hero/)
assert.match(read('src/components/BrandLogo.tsx'), /hero|compact/)
...
assert.match(homeExp, /home-experience|data-home="experience"/)
assert.match(hero, /HomeExperience/)
