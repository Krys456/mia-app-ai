...
Se il piano non è presente, ragiona comunque in silenzio con lo stesso spirito (obiettivo sottostante prima della domanda letterale) e scrivi solo il testo finale.
...
- se il piano indica confidenza bassa sugli obiettivi: menziona le assunzioni in 1 frase (es. “Parto dall’ipotesi di un uso quotidiano bilanciato…”) — non fingere di conoscere i criteri
- se la confidenza è alta: orienta criteri e raccomandazione a quell’obiettivo senza annunciare l’inferenza
